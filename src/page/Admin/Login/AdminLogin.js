...
const AdminLogin = (props) => {
	// 파라미터로 props 넣어줘야 로그인 후 처음화면으로 돌아갈 수 있음
	...
	const handleLogin = (e) => {
		// 값 유효성 체크
		if (adminid === '' || adminpw === '') {
			window.alert(LANGUAGE.admin.login.alert.idAndPassword[lang]);
			return;
		}
	...
	return (
		<Background>
			<div id='login_background'>
				...
				<div id='login_explain'>Sumaro Administrator</div>
				<div id='login_box'>
					<input
						...
						placeholder={LANGUAGE.admin.login.placeholder.email[lang]}
					/>
					<br />
					<input
						className='admin_loginbox'
						...
						placeholder={LANGUAGE.admin.login.placeholder.password[lang]}
					/>
					<br />
					<button type='button' onClick={handleLogin} id='admin_loginbtn'>
						LOGIN
					</button>
				</div>
			</div>
