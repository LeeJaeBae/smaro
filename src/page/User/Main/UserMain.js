...
const UserMain = () => {
	...
	return (
		<Background>
			<div id='link_to_admin'>{/* <Link to={Route.admin.login}>admin▶</Link> */}</div>
			<UserLogo />
			<div>
				<div id='congetion'>
					<Link to={Route.user.congestion}>{LANGUAGE.user.main.getParkingLotStatus[lang]}</Link>
				</div>
				<div className='searchbox'>
					<input
						...
						id='searchMyCarNum'
						name='numberPlate'
						placeholder={LANGUAGE.user.main.inputPlaceholder[lang]}
					/>
			...
			<div>
				{autoCompleteData === null ? (
					...
					autoCompleteData.map(
						(index) => (
							<div className='auto_search_box' ref={testRef} onClick={handleCompleteSearchText}>
